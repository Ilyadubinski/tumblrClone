...
Post.create(title: "Overheard in SF",text: "'The rent is getting expensive'", post_type: "text", user_id: user2.id)
Post.create(title: "Someone Smart-",text: "'The unexamined life is not worth living'", post_type: "text", user_id: user2.id)
